...
public class FaugStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new FaugRuntimeModule());
	}
	
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.json.org/")) {
			EPackage.Registry.INSTANCE.put("http://www.json.org/", JsonPackage.eINSTANCE);
		}
